...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\views\\fastreport\\Table1_IMP.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-ce01676a/Table1_IMP.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	  ...
	  data: function data() {
	    return {
	      ...
	      columns: function () {
	        ...
	        return [{ tag: "F_DQ", shw: { text: "地区", rowspan: 2 }, siz: 20, readOnly: true, align: 'center' }, { tag: "F_KCTR", shw: { text: "勘查投入(万元)", rowspan: 2 }, siz: 20, type: 'numeric', format: '0.00' }, { tag: "F_NMZZZG", shw: { text: "年末在职职工", rowspan: 2 }, siz: 100, type: 'numeric', format: '0' }, { tag: "F_JSRY", shw: { text: "技术人员", rowspan: 2 }, siz: 100, type: 'numeric', format: '0' }, { tag: "F_GZLTJ", shw: [{ text: "完成工作量", colspan: 4 }, "探井(口)"], siz: 100, type: 'numeric', format: '0' }, { tag: "F_GZLZTJC", shw: ["", "钻探进尺(米)"], siz: 100, type: 'numeric', format: '0.00' }, { tag: "F_GZLEWDZ", shw: ["", "二维地震(千米)"], siz: 100, type: 'numeric', format: '0.00' }, { tag: "F_GZLSWDZ", shw: ["", "三维地震(平方千米)"], siz: 100, type: 'numeric', format: '0.00' }, { tag: "F_FGS", shw: { text: "分公司", rowspan: 2 }, align: 'center', siz: 20 }];
	      }()
...
//# sourceMappingURL=8-1c1343aee490e96b0d43.js.map